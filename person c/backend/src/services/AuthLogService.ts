...
export class AuthLogService {
  ...
  static async logAuthAttempt(log: Omit<AuthLog, 'id' | 'synced'>): Promise<void> {
    try {
      ...
      console.error('[AuthLogService] Error logging auth attempt:', error);
      throw error;
    }
  }
  ...
  static async getPendingLogs(): Promise<AuthLog[]> {
    try {
      ...
      console.error('[AuthLogService] Error fetching pending logs:', error);
      return [];
    }
  }
  ...
  static async markLogsAsSynced(ids: number[]): Promise<void> {
    ...
    try {
      ...
      console.error('[AuthLogService] Error marking logs as synced:', error);
      throw error;
    }
  }
  ...
  static async getPendingCount(): Promise<number> {
    try {
      ...
      console.error('[AuthLogService] Error getting pending count:', error);
      return 0;
    }
  }
  ...
  static async purgeSyncedLogs(): Promise<void> {
    try {
      ...
      console.error('[AuthLogService] Error purging synced logs:', error);
      throw error;
    }
  }
}
